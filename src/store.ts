 ...
 * Environment Store
 *
 * Manages environment variable storage and updates.
 */
...
export class EnvironmentStore {
	...
	private options: EnvironmentStoreOptions;

	constructor(options: EnvironmentStoreOptions = {}) {
		this.options = {
	...
	set(key: string, value: any): void {
		...
		if (this.options.updateProcessEnv && typeof process !== "undefined") {
