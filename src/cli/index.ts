...
const generateEnvImplementation = (envVars: Record<string, string>, options: {
    ...
    implementation += '    console.error(\'❌ Invalid environment variables:\', error.format());\n';
        ...
        .action(async (options:any) => {
            try {
                ...
                if (envFiles.length === 0) {
                    console.log(chalk.yellow('⚠️  No .env files found. Creating a sample .env file...'));
...
`);
                ...
                console.log(chalk.blue('📁 Found .env files:'));
                ...
                console.log(chalk.green(`✅ Generated type definitions at ${path.join(typesDir, 'env.d.ts')}`));
                ...
                console.log(chalk.green(`✅ Generated environment implementation at ${outputPath}`));
